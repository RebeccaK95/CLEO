...
challenges_bathroom = Challenge.create([ 
{name: "Make your own beauty products",
...
challenges_transportation = Challenge.create([ 
{name: "Stay away from your car!",
...
challenges_lifestyle = Challenge.create([ 
{name: "Bye bye plastic bags",
...
challenges_food = Challenge.create([
{name: "Decrease additives",
...
challenges_energy = Challenge.create([
{name:"Light me up",
